import type { KeyCode } from "jsr:@cliffy/keycode@1.0.0-rc.7";
import {
  bold,
  brightBlue,
  dim,
...
import { dirname, join, normalize } from "jsr:@std/path@~1.0.6";
import { levenshteinDistance } from "jsr:/@std/text@~1.0.7/levenshtein-distance";
...
import { getOs } from "jsr:@cliffy/internal@1.0.0-rc.7/runtime/get-os";
import { isDirectory } from "jsr:@cliffy/internal@1.0.0-rc.7/runtime/is-directory";
import { readDir } from "jsr:@cliffy/internal@1.0.0-rc.7/runtime/read-dir";
import { stat } from "jsr:@cliffy/internal@1.0.0-rc.7/runtime/stat";

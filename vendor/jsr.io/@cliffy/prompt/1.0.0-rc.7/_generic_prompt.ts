import type { Cursor } from "jsr:@cliffy/ansi@1.0.0-rc.7/cursor-position";
import { type Tty, tty } from "jsr:@cliffy/ansi@1.0.0-rc.7/tty";
import { getRuntimeName } from "jsr:@cliffy/internal@1.0.0-rc.7/runtime/runtime-name";
import { type KeyCode, parse } from "jsr:@cliffy/keycode@1.0.0-rc.7";
import {
  bold,
  brightBlue,
  dim,
...
import type { Reader, WriterSync } from "jsr:/@std/io@~0.224.9/types";
...
import { getColumns } from "jsr:@cliffy/internal@1.0.0-rc.7/runtime/get-columns";
import { isTerminal } from "jsr:@cliffy/internal@1.0.0-rc.7/runtime/is-terminal";
import { read } from "jsr:@cliffy/internal@1.0.0-rc.7/runtime/read";

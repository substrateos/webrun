...
class Connection {
    constructor(_iceControlling, options) {
        ...
        Object.defineProperty(this, "checkStart", {
            ...
            value: (pair) => (0, helper_1.cancelable)(async (r) => {
                ...
                if (!(0, fast_deep_equal_1.default)(result.addr, pair.remoteAddr)) {
                    pair.updateState(iceBase_1.CandidatePairState.FAILED);
                    this.checkComplete(pair);
                    r();
                    return;
    ...
    getCandidatePromises(addresses, timeout = 5) {
        ...
        candidatePromises.push(...localStunPromises.map((localPromise) => localPromise.then((l) => l?.localCandidate)));
    ...
    findPair(protocol, remoteCandidate) {
        const pair = this.checkList.find((pair) => (0, fast_deep_equal_1.default)(pair.protocol, protocol) &&

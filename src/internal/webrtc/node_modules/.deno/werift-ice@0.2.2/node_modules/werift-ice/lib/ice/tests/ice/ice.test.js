...
describe("ice", () => {
    ...
    test("test_response_with_invalid_address", async () => {
        ...
        protocol.responseMessage = "bad";
        const pair = new src_2.CandidatePair(protocol, new candidate_1.Candidate("some-foundation", 1, "udp", 2345, "2.3.4.5", 2345, "host"), true);
        await connection.checkStart(pair).awaitable;
        expect(pair.state).toBe(src_2.CandidatePairState.FAILED);
    });
...
describe("sortCandidatePairs", () => {
    it("controlling", () => {
        ...
        const res = (0, src_2.sortCandidatePairs)([host, relay], true);

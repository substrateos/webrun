...
describe("stun", () => {
    test("test_unpack_error_code", () => {
        ...
        const [code, reason] = (0, attributes_1.unpackErrorCode)(data);
    ...
    test("test_unpack_error_code_too_short", () => {
        ...
        try {
            (0, attributes_1.unpackErrorCode)(data);
        }
        catch (error) {
    ...
    test("test_unpack_xor_address_ipv4", () => {
        ...
        const [address, port] = (0, attributes_1.unpackXorAddress)(Buffer.from("0001a147e112a643", "hex"), transactionId);
    ...
    test("test_unpack_xor_address_ipv4_truncated", () => {
        const transactionId = Buffer.from("b7e7a701bc34d686fa87dfae", "hex");
        try {
            (0, attributes_1.unpackXorAddress)(Buffer.from("0001a147e112a6", "hex"), transactionId);
        }
        catch (error) {
    ...
    test("test_unpack_xor_address_ipv6", () => {
        const transactionId = Buffer.from("b7e7a701bc34d686fa87dfae", "hex");
        const [address, port] = (0, attributes_1.unpackXorAddress)(Buffer.from("0002a1470113a9faa5d3f179bc25f4b5bed2b9d9", "hex"), transactionId);
    ...
    test("test_unpack_xor_address_ipv6_truncated", () => {
        const transactionId = Buffer.from("b7e7a701bc34d686fa87dfae", "hex");
        try {
            (0, attributes_1.unpackXorAddress)(Buffer.from("0002a1470113a9faa5d3f179bc25f4b5bed2b9", "hex"), transactionId);
        }
        catch (error) {
    ...
    test("test_unpack_xor_address_too_short", () => {
        const transactionId = Buffer.from("b7e7a701bc34d686fa87dfae", "hex");
        try {
            (0, attributes_1.unpackXorAddress)(Buffer.from("0001", "hex"), transactionId);
        }
        catch (error) {
    ...
    test("test_unpack_xor_address_unknown_protocol", () => {
        const transactionId = Buffer.from("b7e7a701bc34d686fa87dfae", "hex");
        try {
            (0, attributes_1.unpackXorAddress)(Buffer.from("0003a147e112a643", "hex"), transactionId);
        }
        catch (error) {
    ...
    test("test_pack_error_code", () => {
        const data = (0, attributes_1.packErrorCode)([487, "Role Conflict"]);
        expect(data).toEqual(Buffer.from("00000457526f6c6520436f6e666c696374", "hex"));
    });
    test("test_pack_xor_address_ipv4", () => {
        const transactionId = Buffer.from("b7e7a701bc34d686fa87dfae", "hex");
        const data = (0, attributes_1.packXorAddress)(["192.0.2.1", 32853], transactionId);
        expect(data).toEqual(Buffer.from("0001a147e112a643", "hex"));
    });
    test("test_pack_xor_address_ipv6", () => {
        const transactionId = Buffer.from("b7e7a701bc34d686fa87dfae", "hex");
        const data = (0, attributes_1.packXorAddress)(["2001:db8:1234:5678:11:2233:4455:6677", 32853], transactionId);

...
//
// All output is plain text (no ANSI escape codes) so that
// stderr can be piped, logged, and asserted on directly.
// =========================================================
...
/** Rewrites common error messages into more actionable human language. */
function rewriteForHumans(msg: string): string {
    if (!msg) return msg;
